      ...
      <div *ngFor="let toast of toasts$ | async" 
        ...
        <div class="flex items-start">
          ...
          <div class="ml-4 flex-shrink-0">
            <button (click)="remove(toast.id)" class="inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:text-gray-500 transition ease-in-out duration-150">
